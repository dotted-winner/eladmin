...
public class PatientNosServiceImpl implements PatientNosService {
    ...
    public PatientNosDto create(PatientNos resources) {
        if(patientNosRepository.findByUserId(resources.getUserId()) != null){
            throw new EntityExistException(PatientNos.class,"user_id",resources.getUserId()+"");
        }
        if(patientNosRepository.findByUsername(resources.getUsername()) != null){
